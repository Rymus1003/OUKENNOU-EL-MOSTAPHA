      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-5">
                {recentHearings.length > 0 ? recentHearings.map((h, i) => (
                  ...
                  <div className="text-center py-10 opacity-30">
                    ...
                    <p className="text-[10px] font-bold">لا توجد جلسات قادمة مسجلة</p>
                  </div>
                )}
              </div>
           </div>
        ...
        <div className="space-y-8">
           <div className="bg-indigo-900 p-8 rounded-[2rem] shadow-xl text-white">
              ...
              <div className="text-4xl font-black mb-2">{stats.pending_tasks}</div>
              <p className="text-indigo-300 text-[10px] font-bold">تطلب متابعة من المحررين</p>
              <button onClick={() => window.location.reload()} className="w-full mt-8 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold py-3 rounded-xl transition-all text-xs">عرض قائمة المهام</button>
           </div>
        </div>
      </div>
    </div>
